    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connections', models.ManyToManyField(blank=True, help_text='Другие пользователи, с которыми установлено соединение.', related_name='connected_to', to=settings.AUTH_USER_MODEL)),
